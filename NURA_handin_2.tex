...
the algorithms produce correct answers. In this case we see that only for low density does the false position produce the correct answer
but it has a lot more trouble finding it compared to bisection and hence is substantially slower. 
For the other densities it reaches the max iterations without a correct result.
The improved newton raphson method is returning complete nonsense. 
