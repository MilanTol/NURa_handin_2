...
by employing the Fisher-Yates Shuffle algorithm (see \hyperref{https://en.wikipedia.org/wiki/Fisher%E2%80%93Yates_shuffle}).
...
For this we use the quicksort algorithm. This sorting algorithm is implemented inside the Sorter class.
