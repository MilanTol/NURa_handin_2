...
large chunk of probability space not enclosed by p. Beside, evaluating p is quite fast. So for our current 
...
or a function that tightly encloses p (for all parameters), sampling this distrubution would be over 10 times faster.
...
these estimates for $h \rightarrow 0$. Where h is the stepsize used for finite difference. 
