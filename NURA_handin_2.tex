...
Hence we rewrite the integral into an integral over logspace, as this makes sure 
the inner region of the profile, which contributes the most, gets a sufficient amount of samples.
